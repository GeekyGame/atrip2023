...
class _createAtripState extends State<createAtrip> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: _buildappbar(name: "Create a new Trip"),
      ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton(
                                isExpanded: true,
                                underline: SizedBox(),
                                value: dropdownvalue_dd,
                                icon: const Icon(Icons.keyboard_arrow_down),
                                items: dd.map((String items) {
  ...
  _checkData() async {
    ...
    if(flg1 && flg2 && flg3){
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder)=> generateItinerary(lat: LAT,lng: LNG, cityName: cityName, prefList: filteredList,cost: cost, days: dropdownvalue_dd, PpD: dropdownvalue_mm,)));
    }else{
